...
const BlogPostDetail = () => {
    ...
    return (
        <>
            ...
            <div className="w-screen min-h-screen bg-gray-100 px-4 py-8 flex flex-row">
                ...
                <div className="w-3/5 bg-white px-8 py-8 mx-auto">
                        ...
                        <div className="flex flex-col gap-4">
                            {relatedPosts.length > 0 ? (
                                relatedPosts.map((relatedPost) => (
                                    <Card key={relatedPost._id} className="p-2 bg-white">
